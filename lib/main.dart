...
class ChatGPTClone extends StatefulWidget {
  const ChatGPTClone({super.key});

  @override
  State<ChatGPTClone> createState() => _ChatGPTCloneState();
}

class _ChatGPTCloneState extends State<ChatGPTClone> {
